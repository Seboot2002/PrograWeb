                    ...
                    <div>
                        ...
                        <div>
                            <ul className="nav nav-tabs">
                                ...
                                <li className="nav-item">
                                    <a className={tab == 'preferencias' ? 'nav-link active' : 'nav-link'  } href="#" onClick={ e => setTab('preferencias') }>Preferencias</a>
                                </li>
                            </ul>
                        </div>
                        <div className={`${styles.tabs}`}>
                            ...
                            { tab == 'preferencias' && (
                                <div id="preferencias" className="pb-2">
                                  <div className="col-md-6">
                                    <label htmlFor="inputNombres" className="form-label">Idioma</label>
                                ...
                                <div className="col-md-6">
                                    <label htmlFor="inputApellidos" className="form-label">Prefijo</label>
                                    <input type="text" className="form-control"
                                        value={" "} 
                                    />
                                </div>
                                ...
                                <div className="col-md-6">
                                    <label htmlFor="inputDocumentoTipo" className="form-label">Color</label>
                                    <input type="text" className="form-control"
                                        value={" "} 
